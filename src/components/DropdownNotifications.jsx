          ...
          <ul>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800">Toko Ci Leni</span> mengundang anda untuk wawancara</span>
            ...
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-slate-800 ">Margi Salsabila</span> dari PT.Bakti Mandiri memperbarui status lamaran pekerjaan Anda</span>
            ...
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">🚀<span className="font-medium text-slate-800 ">Sekar Ayu</span> dari Nayarit mengirimkan undangan wawancara kepada Anda</span>
